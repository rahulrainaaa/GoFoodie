...
CREATE TABLE IF NOT EXISTS `log_update_Admin` (
  `id` int(64) NOT NULL ,
...
CREATE TABLE IF NOT EXISTS `log_update_CartItem` (
...
CREATE TABLE IF NOT EXISTS `log_update_Category` (
...
CREATE TABLE IF NOT EXISTS `log_update_City` (
...
CREATE TABLE IF NOT EXISTS `log_update_ComboOrders` (
...
CREATE TABLE IF NOT EXISTS `log_update_ComboPlan` (
...
CREATE TABLE IF NOT EXISTS `log_update_ComboPlanItems` (
...
CREATE TABLE IF NOT EXISTS `log_update_Country` (
  `id` int(64) NOT NULL ,
  `country_id` int(64) default NULL,
...
CREATE TABLE IF NOT EXISTS `log_update_Cuisine` (
...
CREATE TABLE IF NOT EXISTS `log_update_CustomerDetail` (
...
CREATE TABLE IF NOT EXISTS `log_update_CustomerShortlistedBranches` (
...
CREATE TABLE IF NOT EXISTS `log_update_Items` (
...
CREATE TABLE IF NOT EXISTS `log_update_Location` (
...
CREATE TABLE IF NOT EXISTS `log_update_Login` (
...
CREATE TABLE IF NOT EXISTS `log_update_OrderSet` (
  `order_set_id` int(11) NOT NULL ,
  `customer_id` int(11) default NULL,
...
CREATE TABLE IF NOT EXISTS `log_update_PaymentTransactions` (
...
CREATE TABLE IF NOT EXISTS `log_update_RechargePlan` (
...
CREATE TABLE IF NOT EXISTS `log_update_RestaurantBranchCategories` (
...
CREATE TABLE IF NOT EXISTS `log_update_RestaurantDetail` (
...
CREATE TABLE IF NOT EXISTS `log_update_RestaurantReviews` (
  `id` int(64) NOT NULL ,
  `customer_id` int(64) default NULL,
  `restaurant_id` int(64) default NULL,
  `branch_id` int(64) default NULL,
...
CREATE TABLE IF NOT EXISTS `log_update_RestaurantType` (
...
CREATE TABLE IF NOT EXISTS `log_update_Session` (
  `id` int(64) NOT NULL ,
  `login_id` int(64) default NULL,
...
CREATE TABLE IF NOT EXISTS `log_update_SimpleRecharge` (
...
CREATE TABLE IF NOT EXISTS `log_update_SubscribedPlans` (
...
CREATE TABLE IF NOT EXISTS `log_update_TelrPayment` (
...
CREATE TABLE IF NOT EXISTS `log_update_Vacation` (
