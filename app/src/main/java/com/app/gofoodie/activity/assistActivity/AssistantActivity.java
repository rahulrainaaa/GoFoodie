...
public class AssistantActivity extends AppCompatActivity {
    ...
    public static class PlaceholderFragment extends Fragment {
        ...
        public View onCreateView(LayoutInflater inflater, ViewGroup container,
            ...
            TextView textViewComment = (TextView) rootView.findViewById(R.id.section_label_comment);
            ImageView imgWelcome = (ImageView) rootView.findViewById(R.id.img_welcome);

            int number = getArguments().getInt(ARG_SECTION_NUMBER);

            textView.setText(Constants.WELCOME_TITLE_TEXT[number]);
            textViewComment.setText(Constants.WELCOME_COMMENT_TEXT[number]);
