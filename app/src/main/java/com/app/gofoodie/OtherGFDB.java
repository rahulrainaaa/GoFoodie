...
public class OtherGFDB {
    ...
    /*
        ...
        Drop VIEW ViewRestaurantBranchLocation;
...
CREATE VIEW `ViewRestaurantBranchLocation` AS

  SELECT
  Login.login_id,
  RestaurantBranchLocation.branch_id,
  RestaurantBranchLocation.location_id,
  RestaurantBranchLocation.restaurant_id,
  RestaurantBranchLocation.branch_name,
  RestaurantBranchLocation.branch_email,
  RestaurantBranchLocation.description,
  RestaurantBranchLocation.profile_icon,
  RestaurantBranchLocation.tags,
  RestaurantBranchLocation.category_id,
  RestaurantBranchLocation.type,
  RestaurantBranchLocation.branch_address,
  RestaurantBranchLocation.branch_postal_code,
  ...
  RIGHT JOIN Login ON Login.login_id = RestaurantDetail.login_id
  RIGHT JOIN RestaurantBranchLocation ON RestaurantBranchLocation.restaurant_id = RestaurantDetail.restaurant_id;
